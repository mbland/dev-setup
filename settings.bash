...
# These are the tools that should get installed regardless of whether they're
...
# These are the tools that should get installed only if not included in the OS
# already.
declare -r TOOLS_ADD_IF_MISSING=(
  'bison'
  'bzip2'
  'clang'
  'curl'
